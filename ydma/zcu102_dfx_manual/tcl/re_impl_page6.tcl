...
add_files ./checkpoint/context_page6.dcp
add_files ./checkpoint/page6.dcp
set_property SCOPED_TO_CELLS { pfm_top_i/dynamic_region/ydma_1/page6_inst } [get_files ./checkpoint/page6.dcp]
...
phys_opt_design
route_design
write_checkpoint -force ./checkpoint/hw_bb_routed_routed_page6.dcp
write_bitstream -cell pfm_top_i/dynamic_region/ydma_1/page6_inst -force ./bitstream/page6.bit
