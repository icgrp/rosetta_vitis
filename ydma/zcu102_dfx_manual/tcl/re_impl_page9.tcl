...
add_files ./checkpoint/context_page9.dcp
add_files ./checkpoint/page9.dcp
set_property SCOPED_TO_CELLS { pfm_top_i/dynamic_region/ydma_1/page9_inst } [get_files ./checkpoint/page9.dcp]
...
phys_opt_design
route_design
write_checkpoint -force ./checkpoint/hw_bb_routed_routed_page9.dcp
write_bitstream -cell pfm_top_i/dynamic_region/ydma_1/page9_inst -force ./bitstream/page9.bit
