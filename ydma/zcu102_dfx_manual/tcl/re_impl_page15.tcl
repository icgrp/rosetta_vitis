...
add_files ./checkpoint/context_page15.dcp
add_files ./checkpoint/page15.dcp
set_property SCOPED_TO_CELLS { pfm_top_i/dynamic_region/ydma_1/page15_inst } [get_files ./checkpoint/page15.dcp]
...
phys_opt_design
route_design
write_checkpoint -force ./checkpoint/hw_bb_routed_routed_page15.dcp
write_bitstream -cell pfm_top_i/dynamic_region/ydma_1/page15_inst -force ./bitstream/page15.bit
