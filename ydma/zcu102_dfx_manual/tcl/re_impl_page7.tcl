...
add_files ./checkpoint/context_page7.dcp
add_files ./checkpoint/page7.dcp
set_property SCOPED_TO_CELLS { pfm_top_i/dynamic_region/ydma_1/page7_inst } [get_files ./checkpoint/page7.dcp]
...
phys_opt_design
route_design
write_checkpoint -force ./checkpoint/hw_bb_routed_routed_page7.dcp
write_bitstream -cell pfm_top_i/dynamic_region/ydma_1/page7_inst -force ./bitstream/page7.bit
