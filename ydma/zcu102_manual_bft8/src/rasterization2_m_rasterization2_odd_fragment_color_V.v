...
// ==============================================================
`timescale 1 ns / 1 ps
module rasterization2_m_rasterization2_odd_fragment_color_V_ram (addr0, ce0, d0, we0, q0,  clk);
...
initial begin
    $readmemh("./rasterization2_m_rasterization2_odd_fragment_color_V_ram.dat", ram);
end
